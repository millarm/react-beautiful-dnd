...
function useTouchSensor(args) {
  var callbacks = args.callbacks,
      ...
      onCaptureStart = args.onCaptureStart,
      onCaptureEnd = args.onCaptureEnd,
      timeForLongPress = args.timeForLongPress;
  var pendingRef = React.useRef(null);
  var isDraggingRef = React.useRef(false);
...
function useDragHandle(args) {
  ...
  }, [callbacks, getDraggableRef, getWindow, canStartCapturing, getShouldRespectForcePress, onCaptureStart, onCaptureEnd, timeForLongPress]);
...
function Draggable(props) {
  ...
  var children = props.children,
      ...
      index = props.index,
      timeForLongPress = props.timeForLongPress,
      mapped = props.mapped,
  ...
  }, [callbacks, canDragInteractiveElements, draggableId, getRef, getShouldRespectForcePress, isDragDisabled, isDragging, isDropAnimating, timeForLongPress]);
